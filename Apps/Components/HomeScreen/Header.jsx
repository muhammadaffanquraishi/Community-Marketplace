    ...
    <View>
      ...
      <View className="p-[9px] px-5 flex flex-row items-center gap-3
       bg-blue-50 mt-5 rounded-full border-[1px] border-blue-200">
        ...
        <TextInput placeholder='Search' className="ml-2 text-[18px] flex-auto" 
        onChangeText={(value)=>setSearchText(value)}
        />

<TouchableOpacity className='rounded-full bg-blue-500 p-2' onPress={(e) => getSearchedItems(searchText)}>
