...
import AddPostScreenStackNav from './AddPostScreenStackNav';
  ...
  return (
    <Tab.Navigator screenOptions={{headerShown:false}}>
        ...
        options={{tabBarLabel:({color})=> (
            <Text style={{color:color, fontSize:10, marginBottom: 3}}>
                Home
            </Text>
        ),
        ...
        <Tab.Screen name='addPost' component={AddPostScreenStackNav} 
        options={{tabBarLabel:({color})=> (
            <Text style={{color:color, fontSize:10, marginBottom: 3}}>
                Add Post
            </Text>
